...
<?php
	...
	$post_column = neytri_get_archive_post_column();

	if( has_post_thumbnail( $post_ID ) ) : ?>
		<a href="<?php echo get_permalink($post_ID);?>" title="<?php printf(esc_attr__('Permalink to %s','neytri'), the_title_attribute('echo=0'));?>">
