...
<?php
	...
	<div class="entry-thumb">
		<?php neytri_template_part( 'blog', 'templates/post-format/post', $post_format, $template_args ); ?>

        <?php do_action( 'neytri_blog_archive_post_format', $enable_post_format, $post_format ); ?>
	</div>
	<!-- Featured Image -->