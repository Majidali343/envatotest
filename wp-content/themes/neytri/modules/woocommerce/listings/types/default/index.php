...
if( !class_exists( 'Neytri_Woo_Listing_Type_Default' ) ) {

    class Neytri_Woo_Listing_Type_Default {
        ...
        function __construct() {
            ...
            /* Initialize Type */
                ...
                $this->type_name = esc_html__('Default', 'neytri');
        ...
        */
            ...
            function module_dir_path() {
                ...
                if( neytri_is_file_in_theme( __FILE__ ) ) {
                    return NEYTRI_MODULE_DIR . '/woocommerce/listings/types/';
                } else {
            ...
            function module_dir_url() {
                ...
                if( neytri_is_file_in_theme( __FILE__ ) ) {
                    return NEYTRI_MODULE_URI . '/woocommerce/listings/types/';
                } else {
        ...
        */
            function render_backend() {
                ...
                /* Custom Product Templates - Options */
                    add_filter( 'neytri_woo_default_product_templates', array( $this, 'woo_default_product_templates'), 10, 1 );
        ...
        */
            function woo_default_product_templates( $templates ) {
                ...
                $default_template = array (
                    'id'              => 'neytri-woo-product-style-template-'.$this->type_slug,
                    'type'            => 'group',
                    'neytri_default_type' => true,
                    'title'           => sprintf( esc_html__( 'Product Templates - %1$s', 'neytri' ), $this->type_name ),
                    'button_title'    => esc_html__('Add New', 'neytri'),
                    'accordion_title' => esc_html__('Add New Template', 'neytri'),
                    'fields'          => neytri_woo_listing_fw_template_settings()->woo_get_options_params( $type_options, 'default' ),
        ...
        */
            function set_type_options() {
                ...
                $type_options['product-custom-class'] = 'wdt-custom-main-shop';
                ...
                $type_options['product-thumb-content']          = array (
                    'enabled'      => array (
                        'icons_group'    => esc_html__('Icons Group', 'neytri'),
                        'button_element' => esc_html__('Button Element', 'neytri')
                    ),
                    'disabled'     => array (
                        'title'          => esc_html__('Title', 'neytri'),
                        'category'       => esc_html__('Category', 'neytri'),
                        'price'          => esc_html__('Price', 'neytri'),
                        'excerpt'        => esc_html__('Excerpt', 'neytri'),
                        'rating'         => esc_html__('Rating', 'neytri'),
                        'separator'      => esc_html__('Separator', 'neytri'),
                        'element_group'  => esc_html__('Element Group', 'neytri'),
                        'swatches'       => esc_html__('Swatches', 'neytri')
                    )
                );
                ...
                $type_options['product-thumb-iconsgroup-style'] = 'product-thumb-iconsgroup-style-bgfill-rounded';
                ...
                $type_options['product-thumb-buttonelement-stretch'] = 'true';
                ...
                $type_options['product-content-content'] = array (
                    ...
                    'disabled'     => array (
                        ...
                        'category'       => esc_html__('Category', 'neytri'),
                        'excerpt'        => esc_html__('Excerpt', 'neytri'),
                        'countdown'      => esc_html__('Count Down', 'neytri'),
                        'separator'      => esc_html__('Separator', 'neytri'),
                        'element_group'  => esc_html__('Element Group', 'neytri'),
                        'swatches'       => esc_html__('Swatches', 'neytri')
                    )
        ...
        */
            function render_frontend() {
                ...
                if( $non_archive_listing ) {
                    ...
                    /* Types CSS */
                        add_filter( 'neytri_woo_non_archive_css', array( $this, 'woo_listings_css_load'), 10, 1 );

                } else {

                    /* Types CSS */
                        add_filter( 'neytri_woo_archive_css', array( $this, 'woo_listings_css_load'), 10, 1 );
            ...
            function for_non_archive_listing() {
                ...
                /* Assets Load */
                    ...
                    // CSS
                        ...
                        wp_register_style( 'neytri-woo-non-archive', '', array (), NEYTRI_THEME_VERSION, 'all' );
                        wp_enqueue_style( 'neytri-woo-non-archive' );
                        ...
                        $css = apply_filters( 'neytri_woo_non_archive_css', $css );

                        if( !empty($css) ) {
                            wp_add_inline_style( 'neytri-woo-non-archive', $css );
                        }

                    // JS

                        wp_register_script( 'neytri-woo-non-archive', '', array ('jquery'), false, true );
                        wp_enqueue_script( 'neytri-woo-non-archive' );
                        ...
                        $js = apply_filters( 'neytri_woo_non_archive_js', $js );

                        if( !empty($js) ) {
                            wp_add_inline_script( 'neytri-woo-non-archive', $js );
                        }
...
if( !function_exists('neytri_woo_listing_type_default') ) {
	function neytri_woo_listing_type_default() {
		return Neytri_Woo_Listing_Type_Default::instance();
	}
}

neytri_woo_listing_type_default();