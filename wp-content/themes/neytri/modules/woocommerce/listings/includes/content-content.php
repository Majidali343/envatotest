...
if( ! function_exists( 'neytri_shop_woo_loop_product_content' ) ) {

	function neytri_shop_woo_loop_product_content() {
		...
		if($product_content_enable) {
			...
			if($product_content_content) {
				...
				neytri_shop_woo_loop_product_content_content_setup($product_content_content);
				...
				echo '<div class="product-details">';
					...
					// Others
					do_action('neytri_woo_loop_product_content_content', 'content');
					remove_all_actions('neytri_woo_loop_product_content_content');
				echo '</div>';
	...
	add_action( 'woocommerce_shop_loop_item_title', 'neytri_shop_woo_loop_product_content', 10 );
