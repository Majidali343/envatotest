...
if( !class_exists( 'Neytri_Woo_Listing_Tag' ) ) {

    class Neytri_Woo_Listing_Tag {
        ...
        */
            function woo_default_settings() {
                ...
                $this->settings = apply_filters( 'neytri_woo_tag_page_default_settings', $this->settings );
...
if( !function_exists('neytri_woo_listing_tag') ) {
	function neytri_woo_listing_tag() {
		return Neytri_Woo_Listing_Tag::instance();
	}
}

neytri_woo_listing_tag();