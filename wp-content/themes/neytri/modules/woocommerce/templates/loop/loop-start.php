...
/* Customized script - 'neytri_shop_products_list_class' function */
$columns = wc_get_loop_prop('columns');

$classes = apply_filters( 'neytri_woo_listings_class', array () );
$classes = ( is_array ($classes) && !empty ($classes) ) ? implode( ' ', $classes ) : '';

$settings = neytri_woo_listing_shop()->woo_default_settings();
extract($settings);
...
if( function_exists ( 'neytri_woo_loop_column_class' ) ) {
	...
	<li class="product isotope-grid-sizer">
		<div class="<?php echo neytri_woo_loop_column_class ( $columns ); ?>"></div>
	</li>
	<?php
}