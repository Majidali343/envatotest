...
if( !class_exists( 'Neytri_Woo_Others' ) ) {

    class Neytri_Woo_Others {
        ...
        */
            function woo_default_settings() {
                ...
                $this->settings = apply_filters( 'neytri_woo_others_settings', $this->settings );
...
if( !function_exists('neytri_woo_others') ) {
	function neytri_woo_others() {
		return Neytri_Woo_Others::instance();
	}
}
