...
if( !class_exists( 'Neytri_Woo_Listing_Shop' ) ) {

    class Neytri_Woo_Listing_Shop {
        ...
        */
            function woo_default_settings() {
                ...
                $this->settings = apply_filters( 'neytri_woo_shop_page_default_settings', $this->settings );
...
if( !function_exists('neytri_woo_listing_shop') ) {
	function neytri_woo_listing_shop() {
		return Neytri_Woo_Listing_Shop::instance();
	}
}

neytri_woo_listing_shop();