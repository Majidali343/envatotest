...
if( !class_exists( 'Neytri_Shop_Single_Module_Upsell_Related' ) ) {

    class Neytri_Shop_Single_Module_Upsell_Related {
        ...
        */
            ...
            function module_dir_path() {
                ...
                if( neytri_is_file_in_theme( __FILE__ ) ) {
                    return NEYTRI_MODULE_DIR . '/woocommerce/single/modules/upsell-and-related/';
                } else {
            ...
            function module_dir_url() {
                ...
                if( neytri_is_file_in_theme( __FILE__ ) ) {
                    return NEYTRI_MODULE_URI . '/woocommerce/single/modules/upsell-and-related/';
                } else {
        ...
        */
            function woo_load_listing( $product_style_template, $product_style_custom_template ) {
                ...
                if( $product_style_template == 'predefined' ) {
                    $type_class_instance = 'neytri_woo_listing_type_'.$product_style_custom_template; // Type Class Instance
...
if( !function_exists('neytri_shop_single_module_upsell_related') ) {
	function neytri_shop_single_module_upsell_related() {
		return Neytri_Shop_Single_Module_Upsell_Related::instance();
	}
}

neytri_shop_single_module_upsell_related();