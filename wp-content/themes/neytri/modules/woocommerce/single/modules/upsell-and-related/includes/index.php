...
if( ! function_exists( 'neytri_shop_woo_show_upsell' ) ) {

	function neytri_shop_woo_show_upsell() {

		global $product;

        $settings = neytri_woo_single_core()->woo_default_settings();
        $settings = apply_filters( 'neytri_woo_single_upsell_related_settings', $settings );

		if( $settings['product_upsell_display'] ) {

			neytri_shop_single_module_upsell_related()->woo_load_listing( $settings['product_upsell_style_template'], $settings['product_upsell_style_custom_template'] );
			...
			neytri_shop_product_style_reset_loop_prop(); /* Reset Product Style Loop Prop */

		}

	}

	add_action( 'woocommerce_after_single_product_summary', 'neytri_shop_woo_show_upsell', 15 );
...
if( ! function_exists( 'neytri_shop_woo_show_related_products' ) ) {

	function neytri_shop_woo_show_related_products() {
		...
		if( $settings['product_related_display'] ) {
			...
			neytri_shop_single_module_upsell_related()->woo_load_listing( $settings['product_related_style_template'], $settings['product_related_style_custom_template'] );
	...
	add_action( 'woocommerce_after_single_product_summary', 'neytri_shop_woo_show_related_products', 20 );
...
if( ! function_exists( 'neytri_shop_woo_single_upsell_related_settings' ) ) {

	function neytri_shop_woo_single_upsell_related_settings( $settings ) {

        if( !function_exists( 'neytri_pro' ) ) {
        ...
        if( isset( $custom_settings['show-upsell'] ) && $custom_settings['show-upsell'] == 'admin-option' ) {
            ...
            $settings['product_upsell_display'] = neytri_customizer_settings('wdt-single-product-upsell-display' );
            $settings['product_upsell_column']  = neytri_customizer_settings('wdt-single-product-upsell-column' );
            $settings['product_upsell_limit']   = neytri_customizer_settings('wdt-single-product-upsell-limit' );
        ...
        $product_upsell_style_custom_template = neytri_customizer_settings('wdt-single-product-upsell-style-template' );
        ...
        if( isset( $custom_settings['show-related'] ) && $custom_settings['show-related'] == 'admin-option' ) {
            ...
            $settings['product_related_display'] = neytri_customizer_settings('wdt-single-product-related-display' );
            $settings['product_related_column']  = neytri_customizer_settings('wdt-single-product-related-column' );
            $settings['product_related_limit']   = neytri_customizer_settings('wdt-single-product-related-limit' );
        ...
        $product_related_style_custom_template = neytri_customizer_settings('wdt-single-product-related-style-template' );
	...
	add_filter( 'neytri_woo_single_upsell_related_settings', 'neytri_shop_woo_single_upsell_related_settings', 10, 1 );
...
if( ! function_exists( 'neytri_shop_product_style_reset_loop_prop' ) ) {

	function neytri_shop_product_style_reset_loop_prop() {

		$neytri_shop_loop_prop = wc_get_loop_prop('wdt-shop-loop-prop', array ());

		if( is_array($neytri_shop_loop_prop) && !empty($neytri_shop_loop_prop) ) {
			foreach( $neytri_shop_loop_prop as $loop_prop ) {
...
if( ! function_exists( 'neytri_shop_woo_related_products_heading' ) ) {

	function neytri_shop_woo_related_products_heading($heading) {
		...
		if( ( $product_template == 'custom-template' && $product_related_hide_title != 'true' ) || $product_template == 'woo-default' ) {
			...
			$title = neytri_customizer_settings( 'wdt-single-product-related-title' );
	...
	add_filter( 'woocommerce_product_related_products_heading', 'neytri_shop_woo_related_products_heading', 1 );
...
if( ! function_exists( 'neytri_shop_woo_upsells_products_heading' ) ) {

	function neytri_shop_woo_upsells_products_heading($heading) {
		...
		if( ( $product_template == 'custom-template' && $product_upsell_hide_title != 'true' ) || $product_template == 'woo-default' ) {
			...
			$title = neytri_customizer_settings( 'wdt-single-product-upsell-title' );
            $heading = ( isset($title) && !empty($title) ) ? $title : $heading;
	...
	add_filter( 'woocommerce_product_upsells_products_heading', 'neytri_shop_woo_upsells_products_heading', 1 );
